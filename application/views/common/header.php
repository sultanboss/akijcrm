...
<html lang="en">
	<head>
		<meta charset="UTF-8">
		<title><?php echo (isset($title)) ? $title:'Mangorate'; ?></title>    
				...
				<div class="container">
					<div class="row">
						<div class="col-xs-6 col-sm-2">
							<a href="<?php echo base_url(); ?>" class="logo_main" title=""><img src="<?php echo $this->config->item('admin_img_url'); ?>logo1.png" alt=""></a>
						</div>
